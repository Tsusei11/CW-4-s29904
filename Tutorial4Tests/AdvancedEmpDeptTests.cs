    ...
    public void ShouldReturnTotalIncomeIncludingCommission()
    {
        ...
        var result = emps
            .Select(
                ...
                {
                    e.EName,
                    Total = e.Sal + (e.Comm != null ? e.Comm : 0)
                }); 
    ...
    public void ShouldJoinEmpDeptSalgrade()
    {
        ...
        var result = emps
            ...
            .Join(
                ...
                _ => true,
                (ed, g) => new {ed,g})
            .Where(join => join.ed.e.Sal >= join.g.Losal && join.ed.e.Sal <= join.g.Hisal)
            .Select(join => new {join.ed.e.EName, join.ed.d.DName, join.g.Grade}); 
